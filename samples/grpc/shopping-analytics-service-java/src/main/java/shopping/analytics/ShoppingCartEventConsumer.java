...
//#initProjections
import pekko.cluster.sharding.typed.javadsl.ShardedDaemonProcess;
import pekko.japi.Pair;
import pekko.persistence.Persistence;
import pekko.persistence.query.typed.EventEnvelope;
import pekko.projection.ProjectionBehavior;
import pekko.projection.ProjectionId;
import pekko.projection.eventsourced.javadsl.EventSourcedProvider;
import pekko.projection.grpc.consumer.javadsl.GrpcReadJournal;
import pekko.projection.javadsl.SourceProvider;
import pekko.projection.r2dbc.javadsl.R2dbcProjection;
